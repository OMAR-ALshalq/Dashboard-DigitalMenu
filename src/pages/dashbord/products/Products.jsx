...
export default function Products() {
  ...
  const handleEdit = (item) => {
    ...
    setImage(item.image || "");
    setIsAvailable(item.isAvailable);
    setSizes(item.sizes || []); // ✅ تحميل الأحجام الحالية
    setModalOpen(true);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const itemData = {
      ...
      sizes: sizes
        ...
        .map((s) => ({ name: s.name.trim(), price: Number(s.price) })) // ✅ إرسال الأحجام
    };
              ...
              <div className="form-colum-one">
                ...
                <div className="box-input-Products">
                  ...
                  <small style={{ color: "#888" }}>
                    يُستخدم إذا لم يتم إضافة أحجام
                  </small>
                </div>
